...
namespace THYNK.Migrations
{
    ...
    [Migration("20250524123232_AddDisasterReportRatings")]
    partial class AddDisasterReportRatings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("THYNK.Models.AlertReadStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("THYNK.Models.EvacuationSite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("HasBathroomFacilities")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("HasMedicalSupplies")
                        .HasColumnType("bit");

                    b.Property<bool>("HasSleepingFacilities")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("THYNK.Models.UserNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("THYNK.Models.AlertReadStatus", b =>
                {
                    b.HasOne("THYNK.Models.Alert", "Alert")
                        .WithMany()
            ...
            modelBuilder.Entity("THYNK.Models.EvacuationSite", b =>
                {
                    b.HasOne("THYNK.Models.ApplicationUser", "ManagedBy")
                        .WithMany()
